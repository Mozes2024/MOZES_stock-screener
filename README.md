...
### 1. **קודם כל - מטמון, שני - API**

**הנמקה:** רוב הסקנרים מתבססים על נתונים שנשלפים מ-yfinance עם מגבלות קצב קפדניות (כ-2 קריאות לשנייה). סריקת 3,800 מניות דורשת יותר מ-3,800 קריאות API. ב-1 TPS, זה 63 דקות. אבל היסודות משתנים לאט (רווחים רבעוניים), אז למה לאחזר מחדש כל יום?
