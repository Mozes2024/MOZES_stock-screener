...
מערכת מסחר שיטתית ברמת פרודקשן לאיתור סט־אפים בעלי הסתברות גבוהה במניות,  
תוך שימוש בניתוח טכני מבוסס־שלבים, מומנטום חוזק יחסי וסינון פונדמנטלי חכם.

---

## 🧠 סקירה כללית

 מערכת אוטומטית לחלוטין, מונעת־נתונים ה **Intelligent Stock Screener** הכי חזק בעיר - ** MOZES STOCK SCREENER **  
הסורקת מדי יום יותר מ־3,800 מניות בארה״ב ומפיקה אותות קנייה ומכירה  
מבוססי ניתוח טכני, פונדמנטלי וניהול סיכונים קפדני.

המערכת נבנתה כדי:
- לבטל קבלת החלטות רגשית  
- לספק אותות מסחר עקביים וניתנים לשחזור  
- לעבוד בהתאם למתודולוגיות מוכחות (Minervini, O’Neil, Weinstein)
...
1. מחיר מעל SMA 150 ו־200  
2. SMA 150 מעל SMA 200  
3. SMA 200 בעל שיפוע עולה  
4. SMA 50 > 150 > 200  
5. מחיר מעל SMA 50  
6. לפחות 30% מעל השפל השנתי  
7. עד 25% מתחת לשיא השנתי  
8. חוזק יחסי גבוה (RS)
